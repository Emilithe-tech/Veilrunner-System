...
export function actionTreeSchema() {
  return {
    ...
    timing: actionTimingField(),
    economy: actionEconomyField(),
    targeting: actionTargetingField(),
    resourceCosts: resourceCostSchema(),
    requirements: requirementSetField(),
    progression: levelProgressionField({ resource: "skillPoints" }),
